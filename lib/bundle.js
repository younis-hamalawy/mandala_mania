  ...
  _createClass(DrawPad, [{
    ...
    value: function MouseMove(event) {
      ...
      for (var i = 1; i < this.axes + 1; i++) {
        var _rotate = this.rotate(this.midPt.x, this.midPt.y, i, this.axes),
            x1 = _rotate.x,
            y1 = _rotate.y;

        var _rotate2 = this.rotate(this.oldPt.x, this.oldPt.y, i, this.axes),
            x2 = _rotate2.x,
            y2 = _rotate2.y;

        var _rotate3 = this.rotate(this.oldMidPt.x, this.oldMidPt.y, i, this.axes),
            x3 = _rotate3.x,
            y3 = _rotate3.y;
