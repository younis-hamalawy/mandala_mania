...
var DrawPad = function () {
  function DrawPad(canvas) {
    ...
    this.colors = ['#69d025', '#ff3311', '#ccbb33', '#12bdb9', '#ff6644', '#442299', '#ff9933', '#ff4422', '#feae2d', '#d0c310', '#4444dd', '#aacc22', '#22ccaa', '#11aabb', '#3311bb'];
  ...
  _createClass(DrawPad, [{
    ...
    value: function change(value) {
      ...
      return function (event) {
        ...
        if (value === 'stroke') {
          document.getElementById('pointer-size').value = _this.stroke;
        } else if (value === 'axes') {
          document.getElementById('axes').value = _this.axes;
        } else if (value === 'color') {
          document.getElementById('color').value = _this.color;
