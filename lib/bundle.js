  ...
  _createClass(DrawPad, [{
    ...
    value: function MouseDown(event) {
      ...
      for (var i = 1; i < this.axes + 1; i++) {
        var _rotation = (0, _math.rotation)(this.stage.mouseX, this.stage.mouseY, i, this.axes),
            x1 = _rotation.x,
            y1 = _rotation.y;

        this.drawArea.graphics.setStrokeStyle(1).beginStroke(this.color).beginFill(this.color).drawCircle(x1, y1, this.stroke >> 1);
      }
...
var rotation = exports.rotation = function rotation(x, y, n, axes) {
    return {
